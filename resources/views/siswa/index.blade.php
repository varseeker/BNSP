    ...
    <div class="container">
        <div class="card mt-4">
            <div class="card-header">
                Home > Table Siswa <a class="btn btn-primary inline float-right" href="siswa/add" role="button">Tambah</a>
            </div>
            <div class="card-body">
            ...
            <tbody>
                @foreach ($siswa as $key => $siswas)
                    <tr>
                        ...
                        <td>
                            <a href="siswa/show/{{ $siswas->nis }}" class="badge badge-primary">Show</a>
                            <a href="siswa/edit/{{ $siswas->nis }}" class="badge badge-warning">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
