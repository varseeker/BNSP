    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header">
                dashboard > table siswa > {{ $siswa->nis }}
            </div>
            <form action="{{ $siswa->nis }}" method="post">
                @csrf
                @method('PATCH')
            ...
            <div class="card-body">
                ...
                <input disabled type="text" class="form-control" name="nis" id="nis" aria-describedby="helpId" placeholder="{{ $siswa->nis }}">
                ...
                <div class="form-group">
                <input type="text" class="form-control" name="nmsis" id="nmsis" aria-describedby="helpId" placeholder="Nama Siswa" value="{{ $siswa->nmsis }}">
                ...
                <div class="form-group">
                    <select class="custom-select" name="jksis" id="jksis">
                        <option value="Pria" @if($siswa->jksis == 'Pria') selected @endif >Pria</option>
                        <option value="Wanita" @if($siswa->jksis == 'Wanita') selected @endif >Wanita</option>
                    </select>
                ...
                <div class="form-group">
                  <select class="custom-select" name="jurusan" id="jurusan">
                        <option value="RPL" @if($siswa->jurusan == 'RPL') selected @endif>RPL - Rekayasa Perangkat Lunak</option>
                        <option value="MM" @if($siswa->jurusan == 'MM') selected @endif>MM - Multimedia</option>
                        <option value="TKJ" @if($siswa->jurusan == 'TKJ') selected @endif>TKJ - Tekhnik Komputer Jaringan</option>
                    </select>
                ...
                <div class="form-group">
                <input type="text" class="form-control" name="nhnajar" id="nhnajar" aria-describedby="helpId" placeholder="Tahun Ajar Siswa" value="{{ $siswa->nhnajar }}">
                ...
                <div class="form-group">
                <input type="text" class="form-control" name="wali" id="wali" aria-describedby="helpId" placeholder="Wali Siswa" value="{{ $siswa->wali }}">
                ...
                <div class="form-group">
                <input type="text" class="form-control" name="tlpwl" id="tlpwl" aria-describedby="helpId" placeholder="No Telephone/Handphone Siswa" value="{{ $siswa->tlpwl }}">
