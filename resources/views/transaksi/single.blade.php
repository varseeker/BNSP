            ...
            <tbody>
                @foreach ($transaksi as $transaksi)
                    <tr>
                        ...
                        <td>{{ $transaksi->noid }}</td>
                        <td>{{ $transaksi->nis }}</td>
                        <td>{{ $transaksi->jml_bulan }}</td>
                        <td>{{ $transaksi->jml_rupiah }}</td>
                        <td>{{ $transaksi->tglkwi }}</td>
                        <td>{{ $transaksi->keterangan }}</td>
                        <td>
                            <a href="transaksi/show/{{ $transaksi->noid }}" class="badge badge-primary">Show</a>
                            <a href="transaksi/edit/{{ $transaksi->nis }}" class="badge badge-warning">Edit</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
